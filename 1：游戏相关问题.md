...
> - ### **_关于锁帧_**
  ...
  -  _**建议锁60帧（特定关卡需要锁30帧，如上直升飞机）**_ 以保证游玩体验，
        ...
        或安装  **[赠品镜像](b9348.pages.dev)**  中的 [Fusion Fix](https://pan.huang1111.cn/s/9Q2n5Cd?path=%2F)（ _默认锁60帧，可更改_ ）均可实现锁帧。
...
> - ###  **_窗口化运行游戏_**
  ...
  - 安装 [Fusion Fix](https://pan.huang1111.cn/s/9Q2n5Cd?path=%2F) 默认无边框窗口化
...
- 安装[Fusion Fix](https://pan.huang1111.cn/s/9Q2n5Cd?path=%2F) （可调锁帧 无边框窗口化 修复一些bug 提高流畅性）
