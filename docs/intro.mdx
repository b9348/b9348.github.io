...
<Tabs  groupId="下载地址" queryString>
  ...
  <TabItem value="整合包" label="整合包">
    <Link to="https://pub-37c2ca5afb8e423bacfd7b7e81bfe16d.r2.dev/GTA4%E6%B1%89%E5%8C%96%E8%A1%A5%E4%B8%812024-09-13.exe"  >
      <button class="button button--secondary">下载.exe版</button>
    </Link>&nbsp;
    <Link to="https://pub-37c2ca5afb8e423bacfd7b7e81bfe16d.r2.dev/GTA4%E6%B1%89%E5%8C%96%E8%A1%A5%E4%B8%812024-09-13.zip"  >
      <button class="button button--secondary">下载.zip版</button>
    </Link> 
  </TabItem>
...
<Tabs  groupId="备用" queryString>
  <TabItem value="野鸡云" label="野鸡云">
    <Link to="https://drive.almondcloud.cn/s/0QXQIb">
